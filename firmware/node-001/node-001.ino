/*
 * PG Scarecrow — IoT Node 001 (hardcoded config variant)
 *
 ...
 *
 * First boot: connect to "pg-scarecrow-001-setup", pick Wi-Fi, done.
...
static const char* NODE_ID    = "node-001";
static const char* API_KEY    = "3aa07d80746cb35032f203ef5bc10fb4";
...
// ---------- Provisioning ----------
static const char* AP_SSID         = "pg-scarecrow-001-setup";
...
void setup() {
  ...
  delay(300);
  Serial.println();
  Serial.println("PG Scarecrow — node-001");
